...
var all = {
    ...
    secrets: {
        session: process.env.SESSION_SECRET || 'test-api-secret'
    },
    ...
    facebook: {
        clientID: process.env.FACEBOOK_ID || '514771358727801',
        clientSecret: process.env.FACEBOOK_SECRET || 'f445b150bff1351407f21f7124b239f4',
